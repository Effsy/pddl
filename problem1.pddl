...
(:init
  ...
  ; pile1
  (= (time-to-move-between-locations pile1 shelf1) 12)
  (= (time-to-move-between-locations shelf1 pile1) 12)
  ...
  (= (time-to-move-between-locations pile1 shelf4) 12)
  (= (time-to-move-between-locations shelf4 pile1) 12)
  ...
  (= (time-to-move-between-locations shelf1 shelf3) 15)
  (= (time-to-move-between-locations shelf3 shelf1) 15)

  (= (time-to-move-between-locations shelf1 shelf4) 5)
  (= (time-to-move-between-locations shelf4 shelf1) 5)

  (= (time-to-move-between-locations shelf1 shelf5) 7)
  (= (time-to-move-between-locations shelf5 shelf1) 7)
  ...
  (= (time-to-move-between-locations shelf2 shelf4) 7)
  (= (time-to-move-between-locations shelf4 shelf2) 7)

  (= (time-to-move-between-locations shelf2 shelf5) 10)
  (= (time-to-move-between-locations shelf5 shelf2) 10)

  (= (time-to-move-between-locations shelf2 shelf6) 15)
  (= (time-to-move-between-locations shelf6 shelf2) 15)

  ; shelf3
  (= (time-to-move-between-locations shelf3 shelf4) 15)
  (= (time-to-move-between-locations shelf4 shelf3) 15)

  (= (time-to-move-between-locations shelf3 shelf5) 15)
  (= (time-to-move-between-locations shelf5 shelf3) 15)
  ...
  (= (time-to-move-between-locations shelf4 shelf6) 15)
  (= (time-to-move-between-locations shelf6 shelf4) 15)

  ; shelf5
  (= (time-to-move-between-locations shelf5 shelf6) 12)
  (= (time-to-move-between-locations shelf6 shelf5) 12)
...
(:goal (and
   ...
   (book-in-container book7 shelf3)
   (book-in-container book8 shelf4)
   (book-in-container book9 shelf5)
   (book-in-container book10 shelf6)
)))
